...
import (
	...
	"github.com/hbtc-chain/chainnode/chainadaptor/ethereum/factory"
)
...
func (client *ethClient) erc20Decimals(tokenAddress string) (uint8, error) {
	...
	if err != nil {
		log.Error("Failed to create token instance", "err", err)
		return decimals, err
	}
...
func (client *ethClient) unpackTransfer(tokenContract common.Address, data []byte) (to common.Address, amount *big.Int, err error) {
	if client == nil {
...
func (a *ChainAdaptor) validateAndQueryERC20RawTransfer(contract common.Address, tx *types.Transaction) (
